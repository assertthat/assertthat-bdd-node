...
var downloadFeatures = function(settings, callback) {
    const featuresUrl = "https://bdd.assertthat.app/rest/api/1/project/" + settings.projectId + "/features"
...
async function sendReport(settings, filename, runId){
    const reportUrl = "https://bdd.assertthat.app/rest/api/1/project/" + settings.projectId + "/report"
